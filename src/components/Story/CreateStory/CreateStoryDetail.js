          ...
          <Col span={18}>
            <Form layout="vertical" onSubmit={this.createStory}>
              ...
              >
                <Col span={24}>
                  <Form.Item label="Story title">
                    {getFieldDecorator("title", {
                      initialValue:
                        story.title !== "" ? story.title : template.title,
                      rules: [
                        {
                          required: true,
                    ...
                    })(<Input allowClear placeholder="Story title" />)}
                  </Form.Item>
                </Col>
                <Col span={24}>
                  <Form.Item label="Story intro">
                    {getFieldDecorator("intro", {
                      initialValue:
                        story.intro !== "" ? story.intro : template.intro,
                      rules: [
                        { required: true, message: "Please enter an intro!" }
                      ]
                    })(
                      <Input allowClear placeholder="Enter an introduction" />
                    )}
                  </Form.Item>
                </Col>
                <Col span={24}>
                  <Form.Item label="Upload Story Photo">
                    {getFieldDecorator("header_photo", {
                      initialValue:
                        template.placeholder_image !== ""
                          ? template.placeholder_image
                          : image.storyImage
                    })(
                      <div>
                        ...
                        <ImageUpload
                          photoDetails={{
                            typeOfPhoto: "STORY",
                            title: "Adding Photo for New Story",
                            buttonName: "Add Story Photo"
                          }}
                        />
                      </div>
                    )}
                ...
                <Col span={24}>
                  <Form.Item label="Photo caption">
                    {getFieldDecorator("caption", {
                      initialValue:
                        story.caption !== "" ? story.caption : template.caption
                    })(
                      <Input
                        allowClear
