  ...
  createStory = event => {
    ...
    this.props.form.validateFieldsAndScroll((error, values) => {
      if (!error) {
        ...
        let completeDataToSend = {
          story: storyDataToSend,
          chapter: chapterDataToSend,
          contributor: contributorDataToSend
        };

        // send data to the saga
        this.props.dispatch({
          type: "ADD_NEW_STORY",
          payload: completeDataToSend
        });
  ...
  render() {
    ...
    return (
      <Form layout="vertical" onSubmit={this.createStory}>
        <Divider>
          <h2 align="center">Create a Story</h2>
        </Divider>
        ...
        <Form.Item label="Story intro">
          {getFieldDecorator("intro", {
            ...
            <Input
              allowClear
              placeholder={
                story.intro !== "" ? story.intro : "story introduction"
              }
              style={{ width: 340 }}
            />
          )}
        ...
        <Form.Item label="Photo caption">
          {getFieldDecorator("caption", {
            ...
            <Input
              allowClear
              placeholder={
                story.caption !== "" ? story.caption : "add a caption"
              }
              style={{ width: 340 }}
            />
          )}
