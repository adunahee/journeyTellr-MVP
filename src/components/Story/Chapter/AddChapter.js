...
class AddChapter extends Component {
  ...
  addChapter = () => {
    ...
    let dataToSend = { chapter: chapterArray, storyId: this.props.storyId };
    // call reduxSaga for adding a new chapter passing the chapter array and story id
    this.props.dispatch({
      type: "ADD_EXISTING_STORY_CHAPTER",
      payload: dataToSend
    });
  ...
  render() {
    return (
      <div>
        <Button onClick={this.openChapterModal} className="edit-button">
          Add Chapter
        </Button>
        <Modal
