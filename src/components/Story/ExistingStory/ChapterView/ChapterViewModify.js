        ...
        {chapterId !== undefined ? (
          <div>
            <PageHeader
              ...
              subTitle={`in story "${summary.title}" by ${
                summary.author_name
              }${contributorDescription}. `}
            />
            {editMode && (
            ...
            <Card
              ...
              cover={
                <img
                  alt={`Chapter ${chapterId} header`}
                  src={currChapter.chapter_photo}
                />
              }
            >
              <Card.Meta description={currChapter.text} />
            </Card>
            {editMode && (
              <div>
                <ChapterEditButton
