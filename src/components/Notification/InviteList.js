        ...
        renderItem={invite => (
          <List.Item
            actions={[
              <Button
                size="small"
                id="notification-btn"
                onClick={this.handleInvite.bind(this, invite, "accepted")}
              >
                Accept
              </Button>,
              <Button
                size="small"
                id="notification-btn"
                onClick={this.handleInvite.bind(this, invite, "rejected")}
              >
                Maybe Later
              </Button>
            ]}
          >
            <List.Item.Meta
              ...
              description={`${invite.first_name} ${
                invite.last_name
              } invited you to contribute to: "${invite.title}"`}
            />
          </List.Item>
        )}
      />
