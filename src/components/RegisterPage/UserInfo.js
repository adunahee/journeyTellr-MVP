...
class UserInfo extends Component {
  ...
  dummy = () => {
    let dummyProfile = {
      ...
      payload: {
        email: "mattkleven@gmail.com",
        confirm_email: "mattkleven@gmail.com",
        password: "a",
        confirm_password: "a",
        profile_pic:
          "https://journey-tellr-images.s3.amazonaws.com/bucketFolder/1553549316156-lg.jpg"
      }
    };
    ...
    return (
      <form onSubmit={this.registerUser}>
        <Row type="flex" justify="space-around">
          ...
          <Col span={2}>
            <Button onClick={this.dummy} style={{ opacity: 0 }}>
              Dummy
            </Button>
          </Col>
          <Col span={8}>
