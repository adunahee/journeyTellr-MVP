...
class App extends Component {
  ...
  render() {
    ...
    let journeyTellrLogo =
      "./images/kevinslogos/JourneyTellr-Nameonly-color-noR.png";
    return (
      <Router>
        <div>
          ...
          <Row type="flex" justify="center" align="middle" className="nav">
            ...
            <Col span={18}>
              <Link to="/home">
                <img src={journeyTellrLogo} alt={"logo"} className="logo" />
              </Link>
            </Col>
            <Col span={3} />
          </Row>
          ...
          <Switch>
            ...
            <ProtectedRoute exact path="/search" component={SearchMain} />
            ...
            <ProtectedRoute
              exact
              path="/existing-story/:id/chapter/:chapterId"
              component={ExistingStoryMain}
            />
            <Route exact path="/fake-data" component={FakeData} />
            <ProtectedRoute
              exact
              path="/choose-template/detail/"
              component={CreateStoryDetail}
            />
            <ProtectedRoute
              exact
              path="/choose-template/chapter/"
              component={CreateStoryChapter}
            />
            <ProtectedRoute
              exact
              path="/choose-template/contributor/"
