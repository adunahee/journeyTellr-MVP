...
class ProfilePage extends Component {
      ...
      <div className="container">
          ...
          <Row gutter={16}>
            ...
            <Col xs={6}>
              <img
                ...
                className="contain"
                src={this.props.user.userInfo.profile_pic}
                alt="profile-pic"
              />
            </Col>
          ...
          <div className="stats-div">
            <Row gutter={16}>
              <Col xs={24}>
                ...
                <Text className="stats-text">
                  Member since&nbsp;
                  {moment(this.props.user.userInfo.date_created).format(
                    "MMM Do, YYYY"
                  )}
                </Text>
              </Col>
            ...
            <Row gutter={16}>
              <Col xs={24}>
                ...
                />
                <Text className="stats-text">
                  {this.props.story.userStoryReducer.length}&nbsp;Stories
                </Text>
              </Col>
            </Row>
            <Row gutter={16}>
              <Col xs={24}>
                ...
                />
                <Text className="stats-text">
                  {this.props.story.contributedStoryReducer.length}
                  &nbsp;Contributions
                </Text>
              </Col>
            </Row>
        ...
        <div align="center">
          ...
          <Row gutter={16}>
            <Col xs={24}>
              {this.props.story ? (
                <ContributedStoryList history={this.props.history} />
              ) : (
                <p>loading...</p>
              )}
            </Col>
    ...
    return (
      <Col xs={12}>
        ...
        <Button
          className="edit-element"
          id="edit-btn"
          onClick={this.submitEditedName.bind(this)}
        >
          Save
        </Button>
      </Col>
  ...
  renderStaticName() {
    return (
      <div>
        <Col xs={16}>
          <Text id="user-name" level={4}>
            {this.props.user.userInfo.first_name}&nbsp;
            {this.props.user.userInfo.last_name}
          </Text>
        </Col>
        <Row gutter={16}>
          <Col xs={8} />
